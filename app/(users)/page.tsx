...
export default function Page() {
  return (
    <section className="flex w-full flex-col items-start">
      <article className="grid grid-cols-2 w-full   container mx-auto gap-12 mt-12">
        <div className="flex flex-col items-center justify-center col-span-2 lg:col-span-1 gap-9  py-6 lg:py-12 ">
          <header className="font-semibold text-primary text-pretty text-4xl md:text-5xl lg:text-5xl tracking-normal flex flex-col items-start gap-2 w-full">
          ...
          <div className="flex flex-row items-center text-neutral-500 tracking-wide w-full text-sm lg:text-base  ">
            <p>
      ...
      <article className="grid grid-cols-2 w-full   container mx-auto gap-12">
        <header className="flex flex-col  items-center px-6 lg:px-0  py-12 lg:py-24  col-span-2 gap-1 lg:container lg:mx-auto ">
          <h1 className="text-primary  font-semibold text-lg">About us</h1>
          <p className="font-bold tracking-widest text-base lg:text-2xl text-pretty  ">
            처음 만나는 농장, 체험부터 배움까지
          </p>
        </header>
        <div className="w-full grid grid-cols-2  col-span-2  container mx-auto gap-6 lg:gap-12">
          ...
          <div className="col-span-2  lg:col-span-1  flex flex-col items-start justify-center gap-6  p-6 lg:p-0  ">
            <div className="flex flex-col lg:flex-row  gap-1 text-2xl lg:text-2xl lg:flex-wrap">
              <p className="font-bold text-base lg:text-2xl text-pretty  ">
            ...
            <div>
              <p className="font-semibold">참여</p>
              <p className="text-neutral-500  text-pretty ">
      ...
      <article className="grid grid-cols-2 w-full   container mx-auto gap-12">
        <header className="flex flex-col items-center px-6 lg:px-0  py-12 lg:py-12  col-span-2 gap-1 lg:container lg:mx-auto ">
          <h1 className="text-primary  font-semibold text-lg">Target</h1>
          <p className="font-bold tracking-widest text-base lg:text-2xl text-pretty  ">
        ...
        <div className="w-full grid grid-cols-2  col-span-2  container mx-auto gap-6 lg:gap-12">
          <div className="col-span-2 lg:col-span-1  ">
            <div className="w-full aspect-[4/3]  bg-contain relative">
              <Image
                src={
          ...
          <div className="col-span-2 lg:col-span-1  flex flex-col items-start justify-center gap-3 ">
            <div className="flex flow-row items-end gap-1">
              <p className="text-3xl font-semibold tracking-wide">미취학아동</p>
              <span className=" text-lg">(5~7세)</span>
            </div>
            <div className="flex flex-col items-start gap-1">
              <div className="flex flex-row items-center gap-2">
                <CheckCircleIcon className="size-6" />
                <p className="font-semibold">자연환경과 과학을 이해하는 체험</p>
              </div>
              <p className="text-neutral-500 ml-7">
                &quot;토마토는 과일일까? 채소일까?&quot;
              </p>
      ...
      <article className="grid grid-cols-2 w-full   container mx-auto gap-12">
        <header className="flex flex-col items-center px-6 lg:px-0  py-12 lg:py-12  col-span-2 gap-1 lg:container lg:mx-auto ">
          <h1 className="text-primary  font-semibold text-lg">Value</h1>
          <p className="font-bold tracking-widest text-base lg:text-2xl text-pretty  text-center ">
            파인파밍은 농업ㆍ농촌에서 배우는 <br />
            교육적인 가치와 경험을 추구합니다.
          </p>
        </header>
        <div className="w-full grid grid-cols-2 lg:grid-cols-3  col-span-2 px-12 gap-3 lg:gap-6">
      ...
      <article className="grid grid-cols-2 w-full   container mx-auto gap-12">
        <div className="flex flex-col items-start gap-3 col-span-2 lg:col-span-1 px-12">
          <header className="flex flex-col items-start px-6 lg:px-0  py-12 lg:py-12  col-span-2 lg:col-span-1 gap-1 lg:container lg:mx-auto ">
        ...
        <div className="col-span-2 lg:col-span-1 flex flex-col px-12">
