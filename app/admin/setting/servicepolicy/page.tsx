...
import {
  createBaseServicePolicy,
  getServicePolicy,
  updateBaseServicePolicy,
} from "./actions";
import {
  createBasePersonalPolicy,
  updateBasePersonalPolicy,
} from "../personalpolicy/actions";
...
export default function Page() {
  ...
  const getRefunPolicydata = async () => {
    //
    let result: any = await getServicePolicy();
    console.log(result);
    if (result.length > 0) {
