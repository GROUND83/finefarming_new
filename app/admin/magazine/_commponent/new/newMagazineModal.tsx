...
import { ReservationNew, ReservationNewType } from "./newReservationSchema";
//
...
export default function NewMagazineModal() {
  ...
  const form = useForm<ReservationNewType>({
    resolver: zodResolver(ReservationNew),
    defaultValues: {
      name: "",
      farmerId: "",
      farmerPhone: "",
  ...
  const onSubmit = form.handleSubmit(async (data: ReservationNewType) => {
