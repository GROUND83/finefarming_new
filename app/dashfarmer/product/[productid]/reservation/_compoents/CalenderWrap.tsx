...
export default function CalenderWrap({ productid }: productidprops) {
  ...
  const getHoliday = async () => {
    ...
    let holidays = await getHolidays(productid);
    console.log("holidays", holidays);
    setFarmHoliday(holidays);
    let allReservationDate = await getAllReservationDate(productid);
  ...
  return (
    <div className="flex flex-row items-start gap-6  col-span-12 bg-white p-3 border">
